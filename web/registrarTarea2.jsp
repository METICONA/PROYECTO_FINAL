<%-- 
    Document   : registrarTarea2
    Created on : 22-11-2020, 01:23:31 PM
    Author     : ANGELO
--%>
        ...
        <section class="full-box dashboard-contentPage">
            ...
            <div class="container-fluid">
                <div class="page-header">
                    <h1 class="text-titles"><i class="zmdi zmdi-book zmdi-hc-fw"></i> area <small>CREAR NUEVA TAREA</small></h1>
                </div>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="ServletController" method="get">
                            ...
                            <br>
                            <fieldset>
                                <legend><i class="zmdi zmdi-money-box"></i> &nbsp; Introducir Carasteristicas de la Tarea que Realizaran</legend>
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Categoria</label>
                                                <input  class="form-control" type="text" name="txtCategoria" >
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group label-floating">
                                        ...
                                        <div class="col-xs-6 col-sm-3">
                                            <div class="form-group label-floating">
                                                ...
                                                <input min="1" max="30" type="number" name="txtDias" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Resumen de la Tarea</label>
                            ...
                            <p class="text-center" style="margin-top: 20px;">
                                <input type="hidden"  name="txtImagen" value="<%=img%>" class="btn btn-info btn-raised btn-sm"/>
                                <input type="hidden"  name="accion" value="RegistrarTarea" class="btn btn-info btn-raised btn-sm"(>
