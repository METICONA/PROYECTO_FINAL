<%-- 
    ...
    Created on : 24-11-2020, 09:16:08 PM
    Author     : ANGELO
--%>
        ...
        <section class="full-box dashboard-contentPage">
            ...
            <div class="container-fluid">
                <div class="page-header">
                    <h1 class="text-titles"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i> Usuarios<small>Empleados</small></h1>
                </div>
                <p class="lead">Lista de los Usuarios que pueden ingresar al sistemas para realizar las Tareas Propuestas por el Administrador</p>
            </div>
                            ...
                            <table class="table table-hover text-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">PASSWORK</th>

                                    </tr>
                                </thead>
                                <%
                                    ArrayList<Usuario> lista = UsuarioDB.obtener_Usuario();
