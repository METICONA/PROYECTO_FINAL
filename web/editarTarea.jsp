<%-- 
    ...
    Created on : 21-11-2020, 10:58:44 PM
    Author     : ANGELO
--%>
        ...
        <section class="full-box dashboard-contentPage">
            ...
            <div class="container-fluid">
                <div class="page-header">
                    <h1 class="text-titles"><i class="zmdi zmdi-book zmdi-hc-fw"></i> EDITAR TAREA </small></h1>
                </div>
                <p class="lead"></p>
            </div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <form method="post" action="ServletController">
                                        <input  class="form-control" type="hidden" name="accion" value="ModificarTarea" readonly maxlength="30">
                                        <div class="col-xs-12">
                                            <div class="form-group label-floating">
                                                <i class="zmdi zmdi-assignment-o"></i>&nbsp; DESCRIPCION DE LA TAREA
                                                <textarea type="text" name="txtDescripcion" value="" class="form-control" rows="2" maxlength="1000" ><%= t.getDescripcion()%></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-6">
                                                        <div class="form-group label-floating">
                                                            ...
                                                            <input type="text" name="txtCategoria" class="form-control" value="<%= t.getCategoria()%>" >
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6">
                                                        <div class="form-group label-floating">
                                                            <i class="zmdi zmdi-assignment-o"></i> &nbsp; NRO TAREA
                                                            <input type="text" name="txtCodigo" class="form-control" value="<%= t.getCodigoTarea()%>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6">
                                                        <div class="form-group label-floating">
                                                            <i class="zmdi zmdi-assignment-o"></i>&nbsp;EMPLEADO
                                                            <input type="text" name="txtNombre" class="form-control" value="<%= t.getNombre()%>" />
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6">
                                                        <div class="form-group label-floating">
                                                            <i class="zmdi zmdi-assignment-o"></i>&nbsp;PRIORIDAD
                                                            <select name="txtPrioridad" class="form-control">
                                                                <option value="<%= t.getPrioridad()%>"><%= t.getPrioridad()%></option>
                                                    ...
                                                    <div class="col-xs-12 col-sm-6">
                                                        <div class="form-group label-floating">
                                                            <i class="zmdi zmdi-assignment-o"></i>&nbsp;FECHA
                                                            <input type="text" name="txtFechaCreacion" class="form-control" value="<%= t.getFechaCreacion()%>" readonly/>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6">
                                                        <div class="form-group label-floating">
                                                            <i class="zmdi zmdi-assignment-o"></i>&nbsp;DIAS
                                                            <input min="1" max="30" type="number" name="txtDias" class="form-control" value="<%= t.getDias()%>" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <p class="text-center" style="margin-top: 20px;"><br>
                                                    ...
                                                    <button type="submit" value="Actualizar" name="btnActualizar" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> Actualizar</button>
                                                </p>                       
                                            </div>
                                        </div>
                                    </form>                                            
