...
public class ServletLogueo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            CallableStatement cl=Conexion.getConexion().prepareCall("{call loguin(?,?)}");
            cl.setString(1, usu);
            cl.setString(2, pas);
            ResultSet rs=cl.executeQuery();

            if(rs.next()){
                //variable de session OK - validar todos los usuarios 
                //Lo almacenare con 3 attributos perfil - nombre - apellido
                ...
                request.setAttribute("msg", "Error Usuario o Password!");
